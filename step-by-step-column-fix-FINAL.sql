-- ============================================================================
-- STEP-BY-STEP COMMUNITY_ID COLUMN ADDITION - FINAL VERSION
...
BEGIN
    ...
    AND t.table_name IN ('users', 'listings', 'weekly_ads', 'ad_bids', 'ad_payments');
    
    RAISE NOTICE '✓ Found % target tables', table_count;
    
    -- List the tables that exist (FIXED: using different variable name and proper aliases)
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables t WHERE t.table_schema = 'public' AND t.table_name = 'listings') THEN
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables t WHERE t.table_schema = 'public' AND t.table_name = 'weekly_ads') THEN
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables t WHERE t.table_schema = 'public' AND t.table_name = 'ad_bids') THEN
...
BEGIN
    ...
    IF EXISTS (SELECT 1 FROM information_schema.tables t WHERE t.table_schema = 'public' AND t.table_name = 'ad_payments') THEN
...
BEGIN
    ...
    -- Update users data
    IF EXISTS (SELECT 1 FROM information_schema.columns c WHERE c.table_schema = 'public' AND c.table_name = 'users' AND c.column_name = 'community_id') THEN
        UPDATE users 
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns c WHERE c.table_schema = 'public' AND c.table_name = 'listings' AND c.column_name = 'community_id') THEN
        UPDATE listings 
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns c WHERE c.table_schema = 'public' AND c.table_name = 'weekly_ads' AND c.column_name = 'community_id') THEN
        UPDATE weekly_ads 
        SET community_id = 'HSC'
        WHERE community_id IS NULL OR community_id = '';
    ...
    -- Update ad_bids data
    IF EXISTS (SELECT 1 FROM information_schema.columns c WHERE c.table_schema = 'public' AND c.table_name = 'ad_bids' AND c.column_name = 'community_id') THEN
        UPDATE ad_bids 
        SET community_id = 'HSC'
        WHERE community_id IS NULL OR community_id = '';
    ...
    IF EXISTS (SELECT 1 FROM information_schema.columns c WHERE c.table_schema = 'public' AND c.table_name = 'ad_payments' AND c.column_name = 'community_id') THEN
        UPDATE ad_payments 
        SET community_id = 'HSC'
        WHERE community_id IS NULL OR community_id = '';
...
BEGIN
    ...
    -- Show which tables have the column (FIXED: using different variable name and proper aliases)
    FOR current_table IN 
