-- ============================================================================
-- STEP-BY-STEP COMMUNITY_ID COLUMN ADDITION - CORRECTED VERSION
...
BEGIN
    ...
    -- List the tables that exist (FIXED: using correct variable type)
    FOR table_name IN 
...
BEGIN
    ...
    -- Show which tables have the column (FIXED: using correct variable type)
    FOR table_name IN 
